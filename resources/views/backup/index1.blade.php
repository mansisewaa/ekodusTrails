...
<section class="hero">
    <section class="position-relative w-100 hero-container d-flex align-items-center justify-content-center bg-dark">
        ...
        <div class="position-relative text-white text-center px-4 hero-text">
            ...
            <p class="display-lead">
                <i>Discover breathtaking landscapes, thrilling experiences, and unforgettable moments.</i>
            </p>
            <a href="{{route('our-treks')}}" class="btn btn-primary btn-lg">Explore Treks</a>
...
<!-- Card Slider Section -->
<section id="upcoming-treks" class="card-slider-section">
    <h2 class="text-center mb-5" data-aos="fade-up">Upcoming Popular Treks</h2>
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <!-- Card 1 -->
            <div class="swiper-slide">
                <div class="card-overlay tilt-card" style="background-image: url('images/brahmatal1.webp');">
                    <div class="card-content tilt-card-content">
            ...
            <!-- Card 2 -->
            <div class="swiper-slide">
                <div class="card-overlay tilt-card" style="background-image: url('images/kedarkanthabanner.webp');">
                    <div class="card-content tilt-card-content">
            ...
            <!-- Card 3 -->
            <div class="swiper-slide">
                <div class="card-overlay tilt-card" style="background-image: url('images/dayarabugyal.webp');">
                    <div class="card-content tilt-card-content">
            ...
            <!-- Card 4 -->
            <div class="swiper-slide">
                <div class="card-overlay tilt-card" style="background-image: url('images/harkidun2.webp');">
                    <div class="card-content tilt-card-content">
            ...
            <!-- Card 5 -->
            <div class="swiper-slide">
                <div class="card-overlay tilt-card" style="background-image: url('images/harkidun.webp');">
                    <div class="card-content tilt-card-content">
    ...
    <div class="container">
        <div class="row align-items-right">
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <div class="trail-map" data-aos="fade-left">
                    <svg class="trail-path" width="100%" height="300" viewBox="0 0 800 600">
                        <path d="M100,500 Q200,450 300,480 T500,400 T700,300" fill="none" stroke="#E76F51" stroke-width="5" stroke-linecap="round" stroke-dasharray="15,15"/>
                        <circle cx="100" cy="500" r="10" fill="#2C6E49"/>
                        <circle cx="300" cy="480" r="10" fill="#2C6E49"/>
                        <circle cx="500" cy="400" r="10" fill="#2C6E49"/>
                        <circle cx="700" cy="300" r="10" fill="#2C6E49"/>
                    </svg>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="image-grid">
                    <div class="image-large image-reveal" data-aos="fade-right">
                        <img src="images/bg2.jpg" alt="Trekking Image 2" class="nature-breathe">
                    </div>
                    <div class="image-small">
                        <img src="images/bg.jpg" alt="Trekking Image 1" data-aos="fade-up" data-aos-delay="200">
                        <img src="images/bg3.jpg" alt="Trekking Image 3" data-aos="fade-up" data-aos-delay="300">
                        <img src="images/brahmatal1.webp" alt="Trekking Image 4" data-aos="fade-up" data-aos-delay="400">
                    </div>
                </div>
            </div>

            <!-- Right Side - Text Content -->
            <div class="info-text col-lg-6 text-light" style="font-style: italic;" data-aos="fade-left">
...
<section class="services-section py-5">
    <div class="container">
        <h2 class="text-center fw-bold mb-4" data-aos="fade-up">Our Services</h2>
        <div class="row g-4">
            <!-- Service 1 -->
...
<section class="testimonial-section">
    <div class="container-fluid px-3 px-sm-5 my-5 text-center">
        <h2 class="mb-5 font-weight-bold" data-aos="fade-up">What Our Client Say</h2>
        <div class="owl-carousel owl-theme">
            <div class="item first prev">
                <div class="card border-0 py-3 px-4 testimonial-card">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        // Initialize the weather effect on hero section
        const heroSection = document.querySelector('.hero');
        const weatherEffect = document.createElement('div');
        weatherEffect.classList.add('weather-effect');
        weatherEffect.setAttribute('data-weather', 'snow');
        heroSection.appendChild(weatherEffect);

        // Enhanced testimonial animation
        $('.testimonial-card').hover(function() {
            $(this).find('.profile-pic').css('transform', 'scale(1.1) rotate(5deg)');
        }, function() {
            $(this).find('.profile-pic').css('transform', 'scale(1) rotate(0deg)');
        });
    });
</script>
@endsection
